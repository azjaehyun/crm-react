...
export default (data, loggingEnabled = false): DataProvider => {
    ...
    function getResponse(type, resource, params) {
        switch (type) {
            ...
            //TODO: hyojin
            //=============================custom=============================
            case 'createForUploadFormData':
                return {
                    data: restServer.addOne(resource, { ...params.data }),
                };
            case 'deleteWithBody':
                return { data: restServer.removeOne(resource, params.id, data) };
            case 'updateSetMethod':
                return {
                    data: restServer.updateOne(resource, params.id, {
                        ...params.data,
                    }),
    ...
    return {
        ...
        //TODO: hyojin
        //=============================custom=============================
        createForUploadFormData: (resource, body) => handle('createForUploadFormData', resource, body),
        deleteWithBody: (resource, body) => handle('deleteWithBody', resource, body),
        updateSetMethod: (resource, params) => handle('updateSetMethod', resource, params),
        //=============================custom=============================
    };
};
