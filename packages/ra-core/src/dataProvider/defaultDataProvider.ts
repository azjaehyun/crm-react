export default {
    ...
    //TODO: hyojin
    //=============================custom==========================
    createForUploadFormData: () => Promise.resolve({ data: null }), // avoids adding a context in tests
    updateSetMethod: () => Promise.resolve({ data: null }), // avoids adding a context in tests
    deleteWithBody: () => Promise.resolve({ data: null }), // avoids adding a context in tests
    //=============================custom==========================
};
