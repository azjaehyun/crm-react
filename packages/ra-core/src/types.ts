...
export type DataProvider = {
    ...
    //TODO: hyojin
    //=============================custom==========================
    createForUploadFormData: (resource: string, params: CreateForUploadFormDataParams) => Promise<CreateResult>;
    deleteWithBody: (resource: string, body: any) => Promise<DeleteResult>;
    updateSetMethod: (resource: string, params: UpdateSetMethodParams) => Promise<UpdateResult>;
    //=============================custom==========================
...
//TODO: hyojin
//=============================custom==========================
export interface UpdateSetMethodParams {
    id: Identifier;
    data: any;
    method: string;
    previousData: Record;
}
export interface CreateForUploadFormDataParams {
    formData: FormData;
}
//=============================custom==========================
...
export type DataProviderProxy = {
    ...
    // TODO: hyojin
    //=============================custom==========================
    createForUploadFormData: (
        resource: string,
        params: CreateForUploadFormDataParams,
        options?: UseDataProviderOptions
    ) => Promise<UpdateResult>;
    updateSetMethod: (
        resource: string,
        params: UpdateSetMethodParams,
        options?: UseDataProviderOptions
    ) => Promise<UpdateResult>;
    deleteWithBody: (resource: string, body: any, options?: UseDataProviderOptions) => Promise<DeleteResult>;
    //=============================custom==========================
